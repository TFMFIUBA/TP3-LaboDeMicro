...
.equ VAL_IZQ_2 = 0x10  ; 0 0 0 1 0 0 0 0  
.equ VAL_IZQ_1 = 0x08  ; 0 0 0 0 1 0 0 0 
.equ VAL_DER_2 = 0x02  ; 0 0 0 0 0 0 1 0   
.equ VAL_DER_1 = 0x01  ; 0 0 0 0 0 0 0 1 
.equ BLANCO = 1
.equ NEGRO = 0
...
doblar_izq_fuerte: ;en mot der subo la vel en un 10%
   ...
   fijo_vel_der: ;subo la vel del mot derecho
               ldi VEL_MOTOR_DER,VEL_MAX
		       sub VEL_MOTOR_DER_AUX,VAR_FUERTE
